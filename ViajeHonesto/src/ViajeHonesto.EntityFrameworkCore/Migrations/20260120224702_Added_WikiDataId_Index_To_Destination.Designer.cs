...
namespace ViajeHonesto.Migrations
{
    ...
    [Migration("20260120224702_Added_WikiDataId_Index_To_Destination")]
    partial class Added_WikiDataId_Index_To_Destination
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ViajeHonesto.Destinations.Destination", b =>
                {
                    ...
                    b.HasIndex("WikiDataId")
                        .IsUnique()
                        .HasFilter("[WikiDataId] IS NOT NULL");

                    b.ToTable("AppDestinations", (string)null);
                });

            modelBuilder.Entity("ViajeHonesto.Destinations.DestinationPhoto", b =>
                {
                    ...
                    b.HasKey("PhotoId", "DestinationId");
            ...
            modelBuilder.Entity("ViajeHonesto.Reviews.Review", b =>
                {
                    b.Property<Guid>("DestinationId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ViajeHonesto.Destinations.DestinationPhoto", b =>
                {
                    b.HasOne("ViajeHonesto.Destinations.Destination", "Destination")
                        .WithMany("Photos")
                        .HasForeignKey("DestinationId")
            ...
            modelBuilder.Entity("ViajeHonesto.Reviews.Review", b =>
                {
                    ...
                    b.OwnsOne("CComment", "Comment", b1 =>
                        {
                            b1.Property<Guid>("ReviewDestinationId")
                                .HasColumnType("uniqueidentifier");

                            b1.Property<Guid>("ReviewUserId")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.HasKey("ReviewDestinationId", "ReviewUserId");

                            b1.ToTable("AppReview");

                            b1.WithOwner()
                                .HasForeignKey("ReviewDestinationId", "ReviewUserId");
                        });
